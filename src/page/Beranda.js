    ...
    return (
        <div>
            ...
            <div className="w-full h-screen bg-cover bg-no-repeat" style={{
                ...
                <div class="h-screen text-8xl leading-tight grid content-center text-white font-bold ml-36">
            ...
            <div className="w-full h-screen bg-white">
                <div className="flex items-center h-screen justify-center">
                    ...
                    <div className="text-xl w-1/3 ml-12">
            ...
            <div className='w-full h-screen'>
                <div className='text-3xl text-center font-extrabold mt-32'>
